...
```javascript
import Vue from "vue";
import VeLiquidfill from "@v-charts/map"; // 兼容 vue2.x 和 vue3.x 的支持, 将会自动加载支持 vue2.x 的支持包或者支持 vue3.x 的支持包
...
```javascript
import Vue from "vue";
import VeLiquidfill from "@v-charts/map/vue2"; // 更好的 Tree Shaking 推荐引入 vue2.x 的专属支持包
...
const app = createApp();
import VeLiquidfill from "@v-charts/map/vue3"; // 更好的 Tree Shaking 推荐引入 vue3.x 的专属支持包
import "@v-charts/map/v-charts.css"; // 需要手动引入样式
